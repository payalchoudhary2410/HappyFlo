    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whatsappLogo.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent whatsappIntent= new Intent (Intent.ACTION_VIEW, Uri.parse("https://api.whatsapp.com/send?phone=+911234567890"));
        ...
        gmailLogo.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[] {"happieflow@gmail.com"});
        ...
        phoneLogo.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Uri number = Uri.parse("tel:+911234567890");
